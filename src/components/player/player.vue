      ...
      <div class="normal-player" v-show="fullScreen">
        ...
        <div class="bottom">
          ...
          <div class="operators">
            ...
            <div @click="changeSong('prev')" class="icon i-left" :class="disableCls">
              <i class="icon-prev"></i>
            </div>
            <div @click='togglePlaying' class="icon i-center" :class="disableCls">
              <i :class="playIcon"></i>
            </div>
            <div @click="changeSong('next')" class="icon i-right" :class="disableCls">
              <i class="icon-next"></i>
            </div>
  ...
  export default {
    ...
    methods: {
      ...
      _getPosAndScale() { // 计算移动到的位置和缩放比例
        ...
        const paddingLeft = 40 // 最后距离左边距的大小
        const paddingBottom = 30 // 最后距离底部的大小
        const paddingTop = 80 // 开始距离顶部的大小
        const width = window.innerWidth * 0.8 // 起始宽度
